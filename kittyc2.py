...
def show_methods():
    clear_screen()
    print(bold("Made by: niggerboo764\n"))
...
def layer7_attack():
    global request_count, active_bots
    clear_screen()
    print(accent("Made by: niggerboo764"))
...
|  | _|__|/  |__/  |_ ___.__. ____ \_____  \ 
|  |/ /  \   __\   __<   |  |/ ___\ /  ____/ 
|    <|  ||  |  |  |  \___  \  \___/       \ 
|__|_ \__||__|  |__|  / ____|\___  >_______ \
     \/               \/         \/        \/                                          
"""))
...
def about_screen():
    ...
    print(grey("\nVersion: v3.0"))
    print(grey("Author: niggerboo764"))
    print(grey("Contact: @ibarkformygirlfriend(Tiktok) "))
    ...
    print(accent(" - To upgrade your plan contact niggerboo764"))
    print()
    input(accent("Press Enter..."))
